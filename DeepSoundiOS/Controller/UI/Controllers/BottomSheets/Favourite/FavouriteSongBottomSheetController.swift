...
class FavouriteSongBottomSheetController: UIViewController, PanModalPresentable{
    ...
    var latestSong:FavoriteModel.Datum
    ...
    override func viewDidLoad() {
        ...
        self.lblSongDuration.text = latestSong.datumDescription
    ...
    init(song: FavoriteModel.Datum) {
        latestSong = song
        super.init(nibName: FavouriteSongBottomSheetController.name, bundle: nil)
    }
