...
class DashboardRecentlyPlayedVC: BaseVC {
    ...
    private func setupUI(){
        ...
        tableView.register(DashboardRecentlyPlayed_TableCell.nib, forCellReuseIdentifier: DashboardRecentlyPlayed_TableCell.identifier)
...
extension DashboardRecentlyPlayedVC:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: DashboardRecentlyPlayed_TableCell.identifier) as? DashboardRecentlyPlayed_TableCell
