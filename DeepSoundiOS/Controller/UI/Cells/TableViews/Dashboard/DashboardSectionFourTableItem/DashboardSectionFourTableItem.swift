...
class DashboardSectionFourTableItem: UITableViewCell {
    ...
    func setupUI(){
        ...
        collectionView.register(DashboardRecentlyPlayed_CollectionCell.nib, forCellWithReuseIdentifier: DashboardRecentlyPlayed_CollectionCell.identifier)
     }
